...
type ClaudeAI_3_7Client struct {
	apiKey string
	model  string
	logger *zap.Logger
	client *http.Client
...
func NewClaudeAI_3_7Client(apiKey, model string, logger *zap.Logger) *ClaudeAI_3_7Client {
	return &ClaudeAI_3_7Client{
		apiKey: apiKey,
		model:  model,
		logger: logger,
		client: &http.Client{
...
func (c *ClaudeAI_3_7Client) GetModelName() string {
	return c.model
}

func (c *ClaudeAI_3_7Client) SendPrompt(ctx context.Context, prompt string, history []models.Message) (string, error) {
...
func (c *ClaudeAI_3_7Client) buildMessages(prompt string, history []models.Message) []map[string]string {
...
func (c *ClaudeAI_3_7Client) parseResponse(resp *http.Response) (string, error) {
	var result struct {
		Content []struct {
